 ...
 */
@JsonIgnoreProperties(ignoreUnknown = true) // Ignoriert unbekannte Felder beim JSON-Lesen (z.B. altes width/height)
public class AreaDefinition implements Serializable {
     ...
     * Verwendet Kommas als Trennzeichen und Punkte als Dezimaltrennzeichen.
     */
    ...
    /**
     * Konvertiert in ein Rectangle2D.Float (PDF-Koordinaten).
     */
